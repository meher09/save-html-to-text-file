...
if response.status_code == 200:
    ...
    if len(wpb_wrapper_elements) >= 2:
        ...
        # Save the second wpb_wrapper class content to a new text file
        with open('second_wpb_wrapper_content.txt', 'w', encoding='utf-8') as output_file:
            output_file.write(str(second_wpb_wrapper))

        print("Second wpb_wrapper content saved to second_wpb_wrapper_content.txt")
    else:
